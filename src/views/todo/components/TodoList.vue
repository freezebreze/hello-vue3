    ...
    <div class="flex flex-col gap-3">
      <transition-group name="list">
        <label
          v-for="item in data"
          :key="item.id"
          class="cursor-pointer p-4 dark:bg-[#262626] dark:text-[#F2F2F2] bg-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 text-black rounded-2 shadow border border-white justify-start items-center gap-3 inline-flex"
        >
          <input
            type="checkbox"
            class="checkbox"
